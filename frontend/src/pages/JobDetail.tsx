...
import { MapPin, Clock, Briefcase, Building2, Calendar, GraduationCap, ChevronLeft, ExternalLink } from 'lucide-react';
...
export default function JobDetail() {
  ...
  const { trackView } = useSeeker();

  useEffect(() => {
    setJob(null); setNotFound(false);
    api.get<Job>(`/jobs/${slug}`)
      .then((r) => { setJob(r.data); trackView(r.data._id, r.data.tags); })
